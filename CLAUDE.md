...
- **Email** : contact@annuaire-logements.fr
...
### Couleurs (Amber)
- Couleurs primaires: `primary-50` à `primary-900` (amber #f59e0b)
- Couleurs accent: `accent-400` à `accent-600` (orange #f97316)
