<?php
/**
 * Configuration Annuaire Logements
...
// ============================================
define('SITE_NAME', 'annuaire-logements.fr');
define('SITE_DOMAIN', 'annuaire-logements.fr');
define('SITE_URL', 'https://annuaire-logements.fr');
define('SITE_TAGLINE', 'Logements & Hébergements en France');
define('SITE_DESCRIPTION', 'Trouvez le logement idéal pour votre séjour en France. Gîtes, hôtels de charme, locations : comparez et réservez au meilleur prix.');
...
// ============================================
$allNetworkSites = [
    ['url' => 'https://annuaire-logements.fr', 'nom' => 'Annuaire Logements', 'anchor' => 'Chambres d\'hôtes & Gîtes'],
];
